        ...
        <div class="nd_top">
            ...
            <form action="index.php?act=updatesp" method="post" enctype="multipart/form-data">
                <div class="input-group1">
                    <input type="hidden" name="id" id="id" value="<?= $spct[0]['id'] ?>">
                </div>
                ...
                <div style="display: flex;">
                    ...
                    <div class="input-group1">
                        <span>Danh mục</span>
                        <input type="text" name="category_id" id="category_id" value="<?= $spct[0]['category_id'] ?>">
                    </div>

                    <div class="input-group1">
                        <span>Tên sản phẩm</span>
                        <input type="text" name="title" id="title" value="<?= $spct[0]['title'] ?>">
                    </div>
                    <div class="input-group1">
                        <span>Giá</span>
                        <input type="text" name="price" id="price" value="<?= $spct[0]['price'] ?>">
                    </div>
                    <div class="input-group1">
                        <span>Giá chưa giảm</span>
                        <input type="text" name="discount" id="discount" value="<?= $spct[0]['discount'] ?>">
                    </div>
                ...
                <div style="display: flex;">
                    <div class="input-group2">
                        <span>Màu sắc</span>
                        <input type="text" name="color" id="color" value="<?= $spct[0]['color'] ?>">
                    </div>
                    <div class="input-group2">
                        <span>Mô tả</span>
                        <input type="text" name="description" id="description" value="<?= $spct[0]['description'] ?>">
                    </div>

                    <div class="input-group2" style="margin-right: 40px;">
                        <span>Ngày tạo</span>
                        <input type="datetime-local" name="created_at" id="created_at" value="<?= $spct[0]['created_at'] ?>">
                    </div>

                    <div class="input-group2">
                        <span>Ngày cập nhật</span>
                        <input type="datetime-local" name="updated_at" id="updated_at" value="<?= $spct[0]['updated_at'] ?>">
                    </div>
                        ...
                        <div class="timkiem">
                            <form method="post" action="index.php?act=searchac">
                                <div class="input-group" style="width: 300px; height:40px;margin-left:10px;margin-bottom:5px;">
                                    ...
                                    <input type="submit" value="Tìm kiếm" name="" style="margin-left:10px;  border-radius: 10px;">
                                </div>
                            </form>
